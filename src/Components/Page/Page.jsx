            ...
            <main>
                <section className="text-center py-12"style={{marginTop:'0px'}}>
                    ...
                    <div className="flex card-container">
                        <Cards color="#F9D5E5" imageSrc='/APTITUDE-APP-LOCK/1.jpg' index={1} handleCardHover={handleCardHover} />
                        <Cards color="#FEC8D8" imageSrc="/APTITUDE-APP-LOCK/2.png" index={2} handleCardHover={handleCardHover} />
                        <Cards color="#FEA3AA" imageSrc="/APTITUDE-APP-LOCK/3.png" index={3} handleCardHover={handleCardHover} />
                        <Cards color="#F8B88B" imageSrc="/APTITUDE-APP-LOCK/4.png" index={4} handleCardHover={handleCardHover} />
                        <Cards color="#FF9F80" imageSrc="/APTITUDE-APP-LOCK/5.png" index={5} handleCardHover={handleCardHover} />
                    </div>
